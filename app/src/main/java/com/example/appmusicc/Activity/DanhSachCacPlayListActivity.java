...
import com.example.appmusicc.Adapter.DanhSachCacPlayListAdapter;
...
public class DanhSachCacPlayListActivity extends AppCompatActivity {
    ...
    DanhSachCacPlayListAdapter adapter;
    @Override
    ...
    private void getData() {
        ...
        Call<List<PlayList>> callBack = data.getDanhSachCacPlayList();
        callBack.enqueue(new Callback<List<PlayList>>() {
            @Override
            public void onResponse(Call<List<PlayList>> call, Response<List<PlayList>> response) {
                ArrayList<PlayList> arrayDSCacPlayList = (ArrayList<PlayList>) response.body();
                adapter = new DanhSachCacPlayListAdapter(DanhSachCacPlayListActivity.this,arrayDSCacPlayList);
                rcViewDSCacPlayList.setLayoutManager(new GridLayoutManager(DanhSachCacPlayListActivity.this,2));
